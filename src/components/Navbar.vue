...
<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
  <div class="container flex flex-wrap justify-between items-center mx-auto">
    <router-link :to="{name : 'home'}" class="flex items-center">
        <!-- <img src="/public/images/logo.png" class="mr-3 h-6 sm:h-9" alt="burats Logo"> -->
        <span class="self-center text-xl font-bold whitespace-nowrap dark:text-white">Burats</span>
    </router-link>
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
        ...
        <li>
           <router-link :to="{name : 'contact'}" class="block py-2 pr-4 pl-3 text-gray-700 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Contact</router-link>
        </li>
      </ul>
    </div>
  </div>
